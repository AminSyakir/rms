            ...
            <div class="card-body">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input name="table_name" type="text" class="form-control" id="table_name" value="<?= $table['table_name']; ?>">
                        <?= form_error('table_name', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>

                    <div class="form-group">
                        <label for="table_capacity">Product Category</label>
                        <select class="form-control" id="table_capacity" name="table_capacity">
                            <?php foreach ($capacity as $c) : ?>
                                <?php if ($c == $table['table_capacity']) : ?>
